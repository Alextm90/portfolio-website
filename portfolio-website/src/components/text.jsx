const textObject = {
  descriptionOne: `A MERN stack app that manages issues with CRUD operations and is deployed using Docker. The project features an authentication system with access and refresh tokens, using Axios interceptors to maintain user authentication. It securely manages sessions by utilizing refresh tokens to maintain user access and protect routes for authenticated users. The backend is tested with Mocha, Chai, and Axios to ensure correct functionality, including user registration and issue management.`,
